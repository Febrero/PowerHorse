...
async function main() {
    ...
    const factory = await ethers.getContractAt(
        "contracts/CrossChainVaultDepositor.sol:IHorseSharesFactory",
        FACTORY
    );
    ...
    const depositAmount = 100n * 10n**6n; // 100 USDT
    const minShares = 100_000n * 10n**18n; // 100k shares minimum
    ...
    const estimateAmount = 100n * 10n**6n;
    try {
